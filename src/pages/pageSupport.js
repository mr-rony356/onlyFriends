  ...
  return (
    <>
      ...
      <div className="support page">
        <h1 className="title support__title">Kontakt</h1>
        <div className="card support__content">
          <div className="support__oppening">
            <h3>Support-Hotline</h3>
            <p className="support__oppeningHours">
              (Montag - Freitag 09:00 - 18:00 Uhr){" "}
            </p>
          </div>
          <a className="lineButton support__number" href={"tel:+41772054730"}>
            {"Tel. +41 77 205 47 30"}
          </a>
